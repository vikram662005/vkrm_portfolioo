...
const aboutWords = [
  { text: "Hey," }, { text: "I'm" },
  { text: "IAM_VIKRAM.", className: "font-bold text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-400" },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 lg:gap-24 items-center">
          ...
          <div className="flex justify-center lg:justify-start pl-0 lg:pl-20">
            <img
              src={aboutImage}
              alt="About"
               className="w-auto h-72 md:h-96 lg:h-[36rem] object-contain drop-shadow-2xl"
            />
          </div>
